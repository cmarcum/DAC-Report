...
```{r fig.cap="Moving Average of DAR Submission to Approval Time", echo=FALSE, warning=FALSE ,message=FALSE}
# approval.time.table.plot <- ggplot(approval.time.moving.avg.table, aes(x=ApprovedMonth,y=ApprovalTime)) +
#   geom_point() +
#   stat_summary(aes(y=ApprovalTime,group=1), fun = mean, colour="cornflowerblue", geom = "line", group=1, size=1) +
#   ylim(0,50)
