...
ylim2 <- boxplot.stats(as.numeric(approval.time.diff.table$ApprovalTimeFromSOToDAC))$stats[c(1, 5)]
...
ylim3 <- boxplot.stats(as.numeric(approval.time.diff.table$ApprovalTimeFromPIToDAC))$stats[c(1, 5)]

approval.time.from.PI.to.DAC.plot <- ggplot(approval.time.diff.table, aes(factor(ApprovedMonth), ApprovalTimeFromPIToDAC)) + geom_boxplot() + 
