...
p <- ggplot(study.status.table.all, aes(x=Month)) +
...
```{r fig.cap="Comparison of Cummulative DAR Made and Studies Released Per Month in current DAC", echo=FALSE, warning=FALSE ,message=FALSE}
