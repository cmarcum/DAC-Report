...
```{r include=FALSE}
dual.y.fig.caption <- sprintf("Comparison of Requests Received and Studies Released by %s", dac)
```
...
```{r fig.cap=growth.compare.caption, echo=FALSE, warning=FALSE ,message=FALSE, figures-side, fig.show="hold", out.width="50%"}
