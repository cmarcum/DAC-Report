...
word.cloud.fig.cap <- sprintf("Word cloud of Study %s (%s)",phs.popular.this.dac,phs.popular.this.dac.study.name)
```
...
wordcloud(words = top.study.term.freq.table$word, freq = top.study.term.freq.table$freq, min.freq = 1, max.words=200, random.order=FALSE, rot.per=0.1, colors=RColorBrewer::brewer.pal(8, "Dark2"))
```
